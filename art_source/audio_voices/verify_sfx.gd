...
# Loads and plays every synthesized SFX headless, to prove the WAVs import and play before they are wired.
#   Godot --headless --audio-driver Dummy --path . --script res://art_source/audio_voices/verify_sfx.gd
