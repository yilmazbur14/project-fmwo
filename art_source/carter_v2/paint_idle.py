...
ROWS = {
    ...
    4: [(25, "###HHHHHHsm###")],
    5: [(23, "##HHHWWWWWWHssmm##")],
    6: [(22, "#HHWWWWHHHHsssssmmd#")],
    7: [(22, "#HWWHHssssssssssmmd#")],
    8: [(21, "#HWHHssssssssssssmmmd#")],
    ...
    15: [(18, "#sdmrsWWiWW#sHms#WWiWWmRdDm#")],
    16: [(18, "#sdmoHsmmmsssHmmssdddmmrdDm#")],
    ...
    29: [(9, "#HHssssssmd#Hsssssm#oOorrR#dssmmmd#smmmmmmddd#")],
    30: [(9, "#Hssssssmmd#Hssssssm#oOrR#dsssmmmmd#dmmmmmmddD#")],
    31: [(8, "#HsssssssmdD#ssssssssm#oR#dssssmmmmd#ddmmmmdddD#")],
    32: [(8, "#smmsssssmdD#dmssssssmm##mmssssmmmdD#DddsmmmddD#")],
    33: [(8, "#HsmmsHHsmd#DsdmmmmmmdddDddmmmmmmdmdD#dssmmmdddD#")],
    34: [(8, "#HssmsHssmd#mssddddddssmDssddddddmmdD#dsmmmmdddD#")],
    35: [(8, "#Hssssssmd#dmsmmHsssssmdDHsssmmdmmdmdD#dsmmmdddD#")],
    # ---------------- abs ----------------
    36: [(8, "#Hsssssmmd#DdssmssssssmdDssssmmdmdmdD#"), (47, "#dmmmmddD#")],
    37: [(8, "#Hssssmmd#"), (19, "#dmsmmmmmmmddDddddddDmmdD#"), (47, "#dmmmdddD#")],
    38: [(8, "#HsssmmdD#"), (19, "#dssmHsssssmdDHsssmmdmmdD#"), (48, "#dmmddD#")],
    39: [(8, "#smmsmdD#"), (20, "#dsmssssssmdDssssmmdmdD#"), (47, "#dmsmmdD#")],
    40: [(9, "#Hsssmd#"), (21, "#dmmmmmmmddDddddddDdD#"), (46, "#sssmmmdD#")],
    41: [(9, "#HHssmd#"), (21, "#mmHsssssmdDHsssmmddD#"), (46, "#ssmmmdD#")],
    42: [(10, "#Hsssmd#"), (22, "#dssssssmdDsssmmddD#"), (44, "##ssmmmddD#")],
    43: [(10, "#Hsssmd#"), (22, "######################sssmmmddD#")],
    # ---------------- speedo / fists ----------------
    44: [(11, "#sssmmd#"), (22, "#BBBBBBBBbbbbbbuu#ssssmmmmmdddD#")],
