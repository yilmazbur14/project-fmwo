...
PAL = {
    ...
    'H': (250, 220, 184, 255),    # highlight  #fadcb8
    's': (238, 195, 154, 255),    # base       #eec39a
    'm': (217, 160, 102, 255),    # cel shadow #d9a066
    'd': (184, 121, 74, 255),     # deep shadow#b8794a
    'D': (138, 82, 54, 255),      # crevice    #8a5236
    ...
    # boots
    'g': (104, 104, 120, 255),    # boot shine
    'k': (52, 52, 62, 255),       # boot base
    'K': (30, 30, 38, 255),       # boot shadow
    # fx
